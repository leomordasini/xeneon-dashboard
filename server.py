#!/usr/bin/env python3
"""
Xeneon Dashboard Server
- Serves all HTML dashboards as static files
- Proxies /api/* requests to Home Assistant (handles auth + CORS)
- Run once: setup_autostart.bat (registers Windows Task Scheduler)
- Manual start: pythonw.exe server.py (no console window)
"""
...
if __name__ == "__main__":
    ...
    print(f"Xeneon Dashboard → http://192.168.1.148:{PORT}/lights.html")
